defmodule GenDebouncerIntegrationTest do
  ...
  test "Integration test" do
    ...
    [
      {1,
       [6, 7, 2, 8, 2, 10, 10, 6, 3, 3, 7, 8, 1, 5, 4, 9, 4, 8, 4, 1, 3, 7, 9, 10, 4, 8, 4, 8]},
      {2,
       [3, 6, 1, 6, 9, 9, 1, 9, 5, 10, 1, 7, 3, 9, 4, 3, 5, 2, 7, 8, 4, 9, 6, 6, 2, 1, 2, 9, 5, 9]},
      {3, [10, 6, 2, 5, 6, 6, 7, 4, 9, 9, 2, 2, 5, 9, 8, 4, 9, 9, 1, 4]}
    ]
